...
from stable_baselines import PPO2, SAC,DQN
...
def stock_trade(stock_file):
    ...
    # env = DummyVecEnv([lambda: StockTradingEnv(df),lambda: StockTradingEnv(df),lambda: StockTradingEnv(df),lambda: StockTradingEnv(df),lambda: StockTradingEnv(df)])
